  ...
  return (
    <div className="h-svh w-screen bg-[#fdf8f1] dark:bg-[#0a0a0a] flex items-center justify-center p-4 overflow-hidden transition-colors duration-500">
      <div className="max-w-5xl w-full flex flex-col lg:flex-row bg-white dark:bg-[#1a1a1a] rounded-[2.5rem] overflow-hidden  border border-primary/10 dark:border-white/5 max-h-[90vh]">
        {/* LEFT COLUMN: Visual Side (Locked static) */}
        <div className="hidden lg:flex w-1/2 bg-primary dark:bg-[#0f1a11] relative overflow-hidden flex-col justify-center p-12">
          {/* Animated Tree Branch - Background only */}
          ...
          <div className="relative z-10 space-y-6">
            ...
            <h1 className="text-5xl font-serif font-bold text-white leading-[1.1]">
              Turn the page <br />
              <span className="text-secondary italic">together.</span>
            </h1>
        ...
        {/* RIGHT COLUMN: The Auth Form (Contained) */}
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12 overflow-y-auto lg:overflow-visible">
          <div className="max-w-sm w-full space-y-6">
            ...
            <div className="lg:hidden text-center mb-4">
              <div className="inline-block bg-primary dark:bg-[#d4a373] p-2.5 rounded-xl rotate-3 mb-2">
                <BookOpen
            ...
            {/* Google Button */}
            <button className="w-full flex items-center justify-center space-x-3 border-2 border-gray-100 dark:border-white/5 py-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-all group">
            ...
            <form className="space-y-3.5" onSubmit={(e) => e.preventDefault()}>
              {/* Dynamic Field: Only shows on Sign Up */}
              {!isSignIn && (
                <div className="space-y-1 animate-in fade-in slide-in-from-top-1 duration-300">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      className="w-full pl-12 pr-5 py-3 bg-gray-50 dark:bg-[#262626] rounded-2xl border-none focus:ring-2 focus:ring-primary/20 dark:text-white text-sm"
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  {isSignIn && (
                    <button
                      type="button"
                      className="text-[10px] text-primary dark:text-[#d4a373] font-bold hover:underline"
                    >
                      Forgot?
                    </button>
                  )}
              ...
              <button className="w-full bg-primary dark:bg-[#d4a373] text-white dark:text-[#1a1a1a] py-3.5 rounded-2xl font-bold shadow-lg shadow-primary/20 hover:-translate-y-0.5 transition-all flex items-center justify-center space-x-2 active:scale-95 mt-2">
            ...
            <p className="text-center text-gray-500 dark:text-gray-400 text-sm">
              ...
              <Link
                ...
                className="text-primary dark:text-[#d4a373] font-bold hover:underline"
              >
